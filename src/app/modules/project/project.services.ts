...
const createProjectIntoDB = async (payload: ICreateProject, currentUser: any) => {
...
const getAllProjectsFromDB = async (currentUser: any) => {
...
const updateProjectInDB = async (projectId: string, payload: IUpdateProject, currentUser: any) => {
...
const deleteProjectFromDB = async (projectId: string, currentUser: any) => {
