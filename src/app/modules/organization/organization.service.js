...
const createOrganization = async (payload, currentUser) => {
    ...
    const hashedPassword = await bcrypt.hash(payload.adminPassword, Number(config.salt) || 12);
...
const getOrganizationByIdFromDB = async (orgId, currentUser) => {
